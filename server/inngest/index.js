...
// create a function to update user DATA TO A DATABASE
...
// create a function to delete user  from A DATABASE
...
// ingest function to send reminder when a new connction request is added
const sendNewConnectionRequestReminder = inngest.createFunction(
  ...
  async({event,step})=>{
    ...
    await step.run('send-connection-request-mail',async()=>{
      ...
      <br/>
      <p>Thanks, <br/> LinkUp - Connecting World Together</p>
      </div>
      `;
...
// innget function to delete atory after 24 hours
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
  ...
  async({step})=> {
    ...
    for(const userId in unseenCount){
      ...
      const subject = ` Yous have ${unseenCount[userId]} unseen messages`;
...
export const functions = [
    syncUserCreation,syncUserUpdation,syncUserDeletion,sendNewConnectionRequestReminder,
